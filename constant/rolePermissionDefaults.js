...
const ALL_MODULES = [
    ...
    "reservations", "queue", "users", "permissions", "reports", "expense",
...
const ROLE_PERMISSION_DEFAULTS = {
    ...
    Manager: {
        ...
        menu: FULL, tables: FULL, reservations: FULL, queue: FULL, users: NONE, permissions: NONE,
    ...
    Cashier: {
        ...
        menu: VIEW, tables: VIEW, reservations: NONE, queue: NONE, users: NONE, permissions: NONE,
    ...
    Captain: {
        ...
        menu: VIEW, tables: FULL, reservations: FULL, queue: FULL, users: NONE, permissions: NONE,
    ...
    "Kitchen Staff": {
        ...
        menu: NONE, tables: NONE, reservations: NONE, queue: NONE, users: NONE, permissions: NONE,
        reports: NONE, expense: NONE, "stock-masters": NONE, "stock-transactions": NONE,
        "stock-recipes": NONE, "stock-reports": NONE, "cash-session": NONE, "ops-billing": NONE,
        "ops-hardware": NONE, "ops-experience": NONE, "ops-ledger": NONE, system: NONE, "audit-log": NONE,
    },
    "Inventory Manager": {
        ...
        menu: VIEW, tables: NONE, reservations: NONE, queue: NONE, users: NONE, permissions: NONE,
