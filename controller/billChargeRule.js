...
// Same findOne-then-update-or-create pattern as addEditServiceCharge
// (controller/hotel.js) - one row per (hotel, rule_for) pair, upserted by
// that pair rather than requiring the client to know a real row id first.
