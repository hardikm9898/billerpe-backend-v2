...
// Endpoints both a person and a restaurant's local exe legitimately call -
// see middleware/deviceOrAdminAuth.js.
const { deviceOrAdminAuth } = require("../middleware/deviceOrAdminAuth")
...
router.get("/headerFooter", deviceOrAdminAuth, headerFooterContent)
router.post("/kotFormatSetting", deviceOrAdminAuth, kotFormatSetting)
router.get("/kotHeaderFooter", deviceOrAdminAuth, kotHeaderFooterContent)
router.post("/hotelLogo", deviceOrAdminAuth, upload.single("hotel_logo"), uploadHotelLogo)
...
router.get("/paymentModeDefault", deviceOrAdminAuth, getPaymentModeDefaults)
router.post("/paymentModeDefault", deviceOrAdminAuth, savePaymentModeDefault)
router.post("/paymentModeDefaultRemove", deviceOrAdminAuth, removePaymentModeDefault)
...
router.get("/getProductImages/:search?", deviceOrAdminAuth, getProductImages)
...
router.get("/menuShowWithVariants", adminAuth, getMenuItemsWithVariants)
...
router.post("/sentEbill", deviceOrAdminAuth, sentEbill)
router.get("/getEbillCredit", deviceOrAdminAuth, getEbillCredit)
...
router.post("/tableBooking", deviceOrAdminAuth, tableBooking)
router.get("/getBookingData", deviceOrAdminAuth, getBookingData)
router.post("/deleteBooking", deviceOrAdminAuth, deleteBookings)
router.post("/updatedBooking/:id", deviceOrAdminAuth, updateBooking)
...
router.get("/qrOrder/pending", deviceOrAdminAuth, getPendingQrOrders)
router.post("/qrOrder/:id/status", deviceOrAdminAuth, updateQrOrderStatus)
router.post("/table/:id/qr-version", deviceOrAdminAuth, regenerateTableQr)
